  ...
  useEffect(() => {
    ...
    if (pathname.startsWith('/dashboard')) {
      if (pathname === '/dashboard') {
        pageMeta = {
          title: 'Dashboard',
          description: 'Manage your Discord servers and settings'
        };
      ...
      } else if (pathname === '/dashboard/servers') {
        pageMeta = {
          title: 'Servers',
        ...
        pageMeta = {
          ...
          description: 'Configure server settings and features'
        };
      } else if (pathname === '/dashboard/staff') {
        pageMeta = {
          title: 'Staff Panel',
          description: 'Access staff management tools and features'
        };
      } else if (pathname === '/dashboard/staff/members') {
        pageMeta = {
          title: 'Team Members',
          description: 'Manage team members and roles'
        };
      } else if (pathname === '/dashboard/staff/commands') {
        pageMeta = {
          title: 'Staff Commands',
          description: 'View and manage staff-only commands'
        };
      } else if (pathname === '/dashboard/staff/logs/economy') {
        pageMeta = {
          title: 'Economy Logs',
          description: 'View economy transaction logs'
        };
      } else if (pathname === '/dashboard/staff/logs/commands') {
        pageMeta = {
          title: 'Command Logs',
    ...
    if (metaTags.ogImage) {
      metaTags.ogImage.setAttribute('content', 'https://cdn.evelina.bot/web/icon.png');
    }
    if (metaTags.favicon) {
      metaTags.favicon.setAttribute('href', 'https://cdn.evelina.bot/web/icon.png');
    }
    if (metaTags.appleTouchIcon) {
      metaTags.appleTouchIcon.setAttribute('href', 'https://cdn.evelina.bot/web/icon.png');
    }
  }, [pathname]);
}
  ...
  useEffect(() => {
    const fetchUserData = async (userId: string) => {
      try {
        ...
        setError('Failed to fetch user data. Please check the user ID and try again.');
        console.error(error);
      }
    };
    ...
    const fetchUserAvatars = async () => {
      ...
      try {
        ...
        const [userData, avatarsResponse] = await Promise.all([
              ...
              <div key={index} className="feature-card rounded-lg overflow-hidden">
                <div className="relative group">
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "https://cdn.evelina.bot/web/icon.png";
                    }}
                  />
                  <a 

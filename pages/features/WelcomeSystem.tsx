...
import { UserPlus, MessageSquare, Settings, Layout, Image, Palette } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        <div className="w-16 h-16 bg-theme/10 rounded-xl flex items-center justify-center mx-auto mb-6">
          <UserPlus className="w-8 h-8 text-theme" />
        </div>
        <h1 className="text-4xl font-bold mb-4">Welcome System</h1>

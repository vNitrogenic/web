...
import { Coins, Briefcase, TrendingUp, Users, ArrowUpCircle, Dice1 as Dice, FlaskRound as Flask } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl font-bold mb-4">Economy System</h1>
        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          Engage your community with an advanced virtual economy
        </p>
      </div>

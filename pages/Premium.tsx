        ...
        {plans.map((plan) => (
          ...
          >
            ...
            <a
              ...
              className="w-full bg-gradient-to-r from-theme to-theme/80 hover:from-theme/90 hover:to-theme/70 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-theme/20 flex items-center justify-center gap-2 mt-auto"
            >
          ...
          {addons.map((addon) => (
            <div key={addon.name} className="feature-card rounded-xl p-6 flex flex-col">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-dark-2 hover:bg-dark-1 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 text-sm mt-4"
              >
                <Coins className="w-4 h-4" />
                Purchase
              </a>
